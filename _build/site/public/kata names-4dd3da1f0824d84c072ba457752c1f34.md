...
with open(file, newline="", encoding="utf-8") as f:
    ...
    for d in data:
        spit_points.append({'front':d['front'].split()[0][:-1], 'back':d['front'].split()[1].capitalize()})
        #spit_points.append({'back':d['front'].split()[0][:-1], 'front':d['front'].split()[1].capitalize()})
display_flashcards(spit_points, shuffle_cards=True)
print(split_points)
table = []
from tabulate import tabulate
for d in spit_points:
